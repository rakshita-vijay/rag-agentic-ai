# -*- coding: utf-8 -*-
"""
Article Prompt Generator.ipynb

Automatically generated by Colab.

Original file is located at
  https://colab.research.google.com/drive/1LSKsknJ_id5ND2dni_u0lXrFCiKXii_d
...
llm = LLM(
  ...
  api_key=GOOGLE_API_KEY # Explicitly passing the API key
)
...
def get_downloads_folder():
  if sys.platform == "win32":
    # Try to get the real Downloads folder from the registry
    try:
      import winreg
